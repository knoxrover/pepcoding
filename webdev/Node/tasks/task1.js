...
/* Creates File structure using fs,path modules.
   Creates Main Directory which consists of 3 topics directories which each has 5 modules each again.
   usage : node task1.js "maindirname" "topic1" "topic2" "topic3" 
*/
